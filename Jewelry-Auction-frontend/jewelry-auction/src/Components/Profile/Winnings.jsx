...
const Winnings = () => {
    ...
    const handleDueClick = async (event) => {
        ...
        try {
            const response = await fetch('https://localhost:7256/api/User/Payment', { // Adjust the URL if necessary
                method: 'POST',
                headers: {
                ...
                <table className="winnings-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>US $1200</td>
                            <td><button className="due-button" onClick={handleDueClick}>Due</button></td>
                        </tr>
                        <tr>
